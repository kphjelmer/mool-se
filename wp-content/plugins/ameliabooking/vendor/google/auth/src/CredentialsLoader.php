...
use AmeliaGoogle\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use AmeliaGoogle\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(
        ...
        $stack = \AmeliaGuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \AmeliaGuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
