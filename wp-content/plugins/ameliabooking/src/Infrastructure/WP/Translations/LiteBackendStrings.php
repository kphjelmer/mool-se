...
class LiteBackendStrings
{
    ...
    public static function getCommonStrings()
    {
        return [
            ...
            'enable_google_social_login' => __('Enable Google Login', 'wpamelia'),
            'enable_facebook_social_login' => __('Enable Facebook Login', 'wpamelia'),
            'facebook_app_id_required'  => __('Facebook App ID is required', 'wpamelia'),
            'facebook_app_secret_required' => __('Facebook App Secret is required', 'wpamelia'),
    ...
    public static function getSettingsStrings()
    {
        return [
            ...
            'allow_admin_book_over_app_tooltip'      => __('If you enable this option, Admin will be able to book appointment over or during<br>another appointment.', 'wpamelia'),
