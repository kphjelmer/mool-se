...
class BackendStrings
{
    ...
    public static function getCommonStrings()
    {
        $labels = Licence\Licence::$premium ? [
            ...
            'booking_not_found'                   => __('Booking not found', 'wpamelia'),
            'booking_not_paid'                    => __('Booking not paid', 'wpamelia'),
            'booking_canceled'                    => __('Booking is canceled', 'wpamelia'),
            ...
            'torch_off'                           => __('Torch off', 'wpamelia'),
            'torch_on'                            => __('Torch on', 'wpamelia'),
            'switch_camera'                       => __('Switch Camera', 'wpamelia'),
            'start_scanner'                       => __('Start Scanner', 'wpamelia'),
            'stop_scanner'                        => __('Stop Scanner', 'wpamelia'),
            'enter_ticket_manually'               => __('Enter E-Ticket details manually', 'wpamelia'),
            'enter_ticket_code'                   => __('Enter ticket code', 'wpamelia'),
            'enter_booking_id'                    => __('Enter booking ID', 'wpamelia'),
    ...
    public static function getSettingsStrings()
    {
        $labels = Licence\Licence::$premium ? [
            ...
            'barion_service'                         => __('Barion Service', 'wpamelia'),
            ...
            'mailchimp_select_list'                  => __('Choose a Mailchimp list', 'wpamelia'),
            'mailchimp_select_list_tooltip'          => __('Choose a Mailchimp list Tooltip', 'wpamelia'),
            'mailchimp_default_checked'              => __('Make "Subscribe" checkbox checked by default', 'wpamelia'),
            'mailchimp_default_checked_tooltip'      => __('If enabled, customers will need to manually uncheck "Subscribe" field if they do not wish to be added to your Mailchimp list.', 'wpamelia'),
            'mailchimp_sign_in'                      => __('Sign In to Mailchimp', 'wpamelia'),
            'mailchimp_sign_in_failed'               => __('There has been an error logging in to Mailchimp. Please try again.', 'wpamelia'),
            'mailchimp_sign_out'                     => __('Sign Out of Mailchimp', 'wpamelia'),
            'mailchimp_sign_out_success'             => __('Successfully signed out of Mailchimp', 'wpamelia'),
            ...
            'recaptcha_roles_tooltip'                => __('Enable this option to add Google reCAPTCHA on the panel login. To activate it, make sure Google reCAPTCHA is also enabled and configured in General settings.', 'wpamelia'),
            ...
            'wc_rule_package_warning'                => __('Please note that all appointments within the package will be canceled as well.', 'wpamelia'),
...
%company_name%', 'wpamelia'),
    ...
    public static function getWhatsNewStrings()
    {
        $labels = Licence\Licence::$premium ? [
            ...
            'version_subtitle'               => __('Update with a couple of features, improvements and bug fixes:', 'wpamelia'),
    ...
    public static function getCustomizeStrings()
    {
        $labels = Licence\Licence::$premium ? [
            ...
            'qr_etickets_evt_button'             => __('Scan E-Tickets Event Button', 'wpamelia'),
