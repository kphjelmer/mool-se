	...
	function initMembershipDirectory() {
		...
		const setupDirectory = ($directory, args = {}) => {
			...
			const membershipData = {
				endPoint: 'wc/v4/memberships/members/directory',
				requestData: {
					page_id: directorySettings.pageId || 0,
					per_page: directorySettings.perPage,
					wc_memberships_block: true,
					...(directorySettings.blockInstanceId && { block_instance_id: directorySettings.blockInstanceId }),
					...requestData,
				},
