...
/**
 * Exception thrown when a user membership unexpectedly fails to be deleted.
 *
 * @since 1.28.0
 */
class UserMembershipDeleteFailedException extends Exception
{
	/**
	 * Constructor.
	 *
	...
	{
		if (! $message) {
			$message = __('Failed to delete the user membership.', 'woocommerce-memberships');
		}
