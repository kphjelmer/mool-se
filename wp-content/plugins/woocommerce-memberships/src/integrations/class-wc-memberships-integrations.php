...
class WC_Memberships_Integrations {
	...
	/**
	 * Checks if Sensei LMS or Sensei Pro is active.
	 * These plugins use the same hooks and class names, so we can easily support both via one single integration class.
	 *
	 * @since 1.21.0
	 *
	 * @return bool
	...
	public function is_sensei_active() : bool {
		...
		return wc_memberships()->is_plugin_active( 'sensei-lms.php' ) || wc_memberships()->is_plugin_active( 'woothemes-sensei.php' );
	}
