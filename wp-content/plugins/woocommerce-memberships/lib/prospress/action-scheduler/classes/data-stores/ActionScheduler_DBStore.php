...
class ActionScheduler_DBStore extends ActionScheduler_Store {
	...
	protected function bulk_cancel_actions( $query_args ) {
		...
		while ( $action_ids ) {
			...
			$wpdb->query( // @phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.PreparedSQLPlaceholders.UnfinishedPrepare
	...
	protected function claim_actions( $claim_id, $limit, \DateTime $before_date = null, $hooks = array(), $group = '' ) {
		...
		$sql = $wpdb->prepare( "{$update} {$where} {$order}", $params ); // @phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.PreparedSQLPlaceholders.UnfinishedPrepare

		$rows_affected = $wpdb->query( $sql ); // @phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
	...
	public function find_actions_by_claim_id( $claim_id ) {
		...
		$sql = $wpdb->prepare( $sql, $claim_id ); // @phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
